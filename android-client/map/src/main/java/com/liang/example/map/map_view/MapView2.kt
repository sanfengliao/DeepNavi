...
package com.liang.example.map.map_view
...
import com.liang.example.map.R
...
open class MapContainer : ViewGroup, MapView2.OnMapStateChangedListener {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        ...
        mEdgeView.background = context.resources.getDrawable(android.R.color.transparent)

        posView = View(context)
        addView(posView)
        posView.layoutParams = LayoutParams(dp2px(40f), dp2px(40f))
        posView.background = context.resources.getDrawable(R.drawable.current_pos)
...
open class EdgeView : View {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        ...
        background = context.resources.getDrawable(android.R.color.transparent)
    }
